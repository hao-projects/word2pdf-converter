...
public class Converter {
    ...
    public void download(MultipartHttpServletRequest request,HttpServletResponse response)throws Exception{
    ...
    public static String executeCommand(String input_path,String output_folder_path){
       return execute("soffice --convert-to pdf --outdir " +output_folder_path+"  "+input_path);
    }
